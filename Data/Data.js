export const DATABOOKS = [
  ...
  },
  {
    ...
    cover: "https://m.media-amazon.com/images/I/91mq5khI9-L._AC_UF1000,1000_QL80_.jpg",
    description:
...
export const slogan = `Bienvenido a <span>Titivillus</span> BookStore, la biblioteca que te transportará a mundos imaginarios y te hará vivir aventuras inolvidables a través de las páginas de sus libros.`;
...
export const invitationBookClub = `¡Bienvenidos a <span>Titivillus</span> BookStore, el lugar perfecto para los amantes de la lectura! Si estás buscando una comunidad de lectores apasionados que disfrutan de compartir sus pensamientos y opiniones sobre los libros, ¡nuestro club de lectura es perfecto para ti!<br>
  ...
  <br>
  ¿Qué esperas? Únete hoy mismo al club de lectura de la Librería Titivillus y comienza tu viaje literario. ¡Haz clic en el botón de abajo para registrarte ahora mismo!
  `;
